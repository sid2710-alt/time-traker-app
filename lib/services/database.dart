...
import 'package:traken/app/home/models/entry.dart';
import 'package:traken/app/home/models/job.dart';
import 'package:traken/services/API_Path.dart';

import 'package:traken/services/firestore_service.dart';
...
class FirestoreDatabase implements Database {
  ...
  @override
  Stream<Job>jobStream({@required String jobId})=>_service.documentStream(path: APIPath.job(uid,jobId), builder:
  (data,documentId)=>Job.fromMap(data, documentId),
  );
